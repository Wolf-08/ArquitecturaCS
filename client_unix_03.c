...
{  
 ...
 char cadenaEnviada [] = "Este es un mensaje para el servidor :)";
 ...
 int res_send = send( dfClient, "Este es un mensaje para el servidor :)\n", strlen(cadenaEnviada), 0 );
 /*El 35 es el tamaño del mensaje si se cambia el mensaje 
 se cambia el tamaño del mensaje */
